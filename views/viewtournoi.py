...
class ViewTournoi:
    def __init__(self, tournament_controller):
        ...
        Args :
        - tournament_controller (obj) : contient un contrôleur
        TournamentController.

        Attrs :
        - tournament_controller (obj) : contient un contrôleur
         TournamentController.
        - selected_tournament (obj) : contient le tournoi
        sélectionné ou créé (initialisé en None).
        - user_choice (int) : contient le choix de
        l'utilisateur dans le menu PlayerView (initialisé sur 0).
    ...
    def show_menu_list(self):
        """Affiche le menu selon la liste
        définie dans le constructeur."""
    ...
    def prompt_user(self):
        ...
        while True:
            ...
            if self.user_choice == "1":
                if len(self.tournament_controller.
                        player_controller.waiting_room) < 8:
                    print()
                    print("Vous n'avez pas assez de "
                          "joueurs pour créer un tournoi !")
                ...
                existing_tournaments = \
                    self.tournament_controller.get_existing_tournaments()
                ...
                if self.selected_tournament:
                    ...
                    if not self.tournament_controller.current_round:
                        ...
                        if user_choice == "1":
                            try:
                                ...
                                print("Vous n'avez pas le nombre "
                                      "de joueurs suffisant !")
                                print("Il faut 8 joueurs pour"
                                      "démarrer un tournoi.")
                            ...
                            break
                        while self.tournament_controller.\
                                current_tournament.current_round_number <= 3:
                            user_choice = self.prompt_user_to_start_round()
                            if user_choice == "1":
                                try:
                                    self.tournament_controller.begin_round()
                        ...
                        while self.tournament_controller.current_tournament.\
                        ...
                        if self.tournament_controller.\
                                current_tournament.\
                                current_round_number == 4 and not \
                                self.tournament_controller.\
                    ...
                    print()
                    print("Attention, vous n'avez pas "
                          "sélectionné ou créé un tournoi.")
                    print()
                    print("Retour au menu.")
                    self.show_menu_list()
                ...
                print()
                print(f"Erreur. Veuillez choisir "
                      f"un numéro entre 1 et "
                      f"{len(self.menu_list)}.")
                print("Retour au menu")
                print()
                self.show_menu_list()

    def create_tournament(self):
        """Crée un tournoi selon les données
        de l'utilisateur et le sélectionne."""
    ...
    def get_tournament_name():
        ...
        name = input("Nom du tournoi "
                     "(Respectez les accents. Exemple : Télé) : "). capitalize()
    ...
    def get_tournament_location():
        """Récupère la localisation du
        tournoi auprès de l'utilisateur."""
        location = input("Localisation du tournoi (Respectez les accents. "
                         "Exemple : Élancourt) : ").capitalize()
        pattern = r"^[a-zA-Z0-9\s]+$"
    ...
    def get_tournament_description():
        ...
        if len(description) <= 1:
            ...
            print("Description trop courte. "
                  "Elle doit au moins contenir deux caractères.")
            print()
        else:
            return description
    ...
    def select_tournament_in_database(self):
        ...
        try:
            ...
            print()
            self.show_tournaments_in_database()
        self.tournament_controller.load_existing_tournament(
            self.selected_tournament)
    ...
    def prompt_user_to_start_round(self):
        """
        Affiche le tournoi, le round et la liste des
        matchs actuels puis demande à l'utilisateur s'il veut
        démarrer le round.
        """
