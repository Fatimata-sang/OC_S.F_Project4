...
class ViewJoueur:
    def __init__(self, player_controller):
        ...
        Attrs :
        - player_controller (obj) : contient un contrôleur PlayerController.
        - SEATS_NUMBER (int) : correspond au nombre de joueurs
        par tournoi (initialisé sur 8 par défaut).
        - user_choice (int) : contient le choix de l'utilisateur
        dans le menu PlayerView (initialisé sur 0).
        - existing_players (list) : liste des joueurs existants
        contenue dans le contrôleur.
        - menu_list (list) : contient les options
        de navigation de la vue.
        """
    ...
    def show_waiting_room(self):
        ...
        if not self.player_controller.waiting_room:
            ...
            print(f"Salle d'attente : "
                  f"{self.player_controller.waiting_room}")
        ...
        while True:
            ...
            if self.user_choice == "1":
                ...
                if self.existing_players:
                    ...
                    print("La base de données est vide. Il faut d'abord sauvegarder un "
                          "tournoi avec des joueurs pour pouvoir les retrouver dans la base de données.")
                    print()
                    print("Retour au menu.")
                    print()
                    self.show_waiting_room()
                ...
                if self.existing_players:
                    ...
                    print("La base de données est vide. Il faut d'abord sauvegarder un tournoi "
                          "avec des joueurs pour pouvoir les retrouver dans la base de données.")
                    print()
                    print("Retour au menu.")
                    print()
                    self.show_waiting_room()
    ...
    def get_player_first_name(self):
        ...
        first_name = input("Prénom du joueur (Respectez les accents. Exemple :Jean-rené ) : ").capitalize()
        pattern = "^[A-Za-zÀ-ÿ'-]+$"
        ...
        while True:
            ...
            if not re.match(pattern, birthdate):
                ...
                if year < player_minimum_birth_year or year > player_maximum_birth_year:
                    print()
                    print("Année de naissance invalide. Veuillez entrer une année "
                          "comprise entre ",
    ...
    def update_remaining_seats(self):
        ...
        if current_seats > 0:
            print(f"Il manque encore {current_seats} "
                  f"joueurs pour démarrer un tournoi !")
